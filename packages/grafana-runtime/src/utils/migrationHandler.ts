import { createStructuredLogger, type DataQueryRequest } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('packages/grafana-runtime/src/utils/migrationHandler.ts');
