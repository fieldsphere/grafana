import { createStructuredLogger, type PanelPlugin } from '@grafana/data';

import { config } from '../config';

const structuredLogger = createStructuredLogger('packages/grafana-runtime/src/utils/plugin.ts');
