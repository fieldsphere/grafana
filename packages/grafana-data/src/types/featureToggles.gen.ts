...
export const featureToggleKeys = [
  ...
  "liveAPIServer",
  "starsFromAPIServer",
  "influxqlStreamingParser",
  "influxdbRunQueriesInParallel",
  "lokiLogsDataplane",
  "disableSSEDataplane",
  "renderAuthJWT",
  "refactorVariablesTimeRange",
  "faroDatasourceSelector",
  "faroSessionReplay",
  "awsDatasourcesTempCredentials",
  "mlExpressions",
  "datasourceAPIServers",
  ...
  "configurableSchedulerTick",
  "dashgpt",
  "aiGeneratedDashboardChanges",
  "reportingCsvEncodingOptions",
  "reportingHeaderSettings",
  "reportingFooterSettings",
  "sseGroupByDatasource",
  "sseExpressionErrorIsolation",
  "lokiRunQueriesInParallel",
  "externalServiceAccounts",
  "kubernetesSnapshots",
  "kubernetesLibraryPanels",
  "kubernetesShortURLs",
  "useKubernetesShortURLsAPI",
  "kubernetesCorrelations",
  "kubernetesUnifiedStorageQuotas",
  "kubernetesLogsDrilldown",
  "kubernetesQueryCaching",
  "dashboardDisableSchemaValidationV1",
  "dashboardDisableSchemaValidationV2",
  "dashboardSchemaValidationLogging",
  "scanRowInvalidDashboardParseFallbackEnabled",
  "datasourceQueryTypes",
  "datasourceLegacyIdApi",
  "queryService",
  "queryServiceWithConnections",
  "useNewAPIsForDatasourceCRUD",
  "queryServiceRewrite",
  "queryServiceFromUI",
  "datasourcesRerouteLegacyCRUDAPIs",
  "datasourcesApiServerEnableResourceEndpoint",
  "datasourcesApiserverEnableResourceEndpointRedirect",
  "datasourcesQuerierRawOutput",
  "cloudWatchBatchQueries",
  "cachingOptimizeSerializationMemoryUsage",
  "alertmanagerRemoteSecondary",
  "alertingProvenanceLockWrites",
  "alertingUIUseBackendFilters",
  "alertingUIUseFullyCompatBackendFilters",
  "createAlertRuleFromPanel",
  "alertmanagerRemotePrimary",
  "annotationPermissionUpdate",
  "annotationsClustering",
  "dashboardNewLayouts",
  "dashboardDefaultLayoutSelector",
  "dashboardAssistantPopover",
  "dashboardUndoRedo",
  "unlimitedLayoutsNesting",
  "sceneCsvExport",
  ...
  "appPlatformGrpcClientAuth",
  "groupAttributeSync",
  "groupToNestedTableV2",
  ...
  "managedDualWriter",
  "pluginsSriChecks",
  "unifiedStorageBigObjectsSupport",
  "timeRangeProvider",
  "timeRangePan",
  "newTimeRangeZoomShortcuts",
  "azureMonitorDisableLogLimit",
  "playlistsReconciler",
  ...
  "alertingAIGenAlertRules",
  "alertingAIFeedback",
  "alertingAIImproveAlertRules",
  "alertingAIGenTemplates",
  "alertingEnrichmentPerRule",
  "alertingEnrichmentAssistantInvestigations",
  "alertingAIAnalyzeCentralStateHistory",
  "alertingNotificationsStepMode",
  "unifiedStorageSearchUI",
  "elasticsearchCrossClusterSearch",
  "lokiLabelNamesQueryApi",
  "improvedExternalSessionHandlingSAML",
  "teamHttpHeadersTempo",
  "teamHttpHeadersFromAppPlatform",
  "teamLBACApiReadFromAppPlatform",
  "grafanaAdvisor",
  "elasticsearchImprovedParsing",
  "datasourceConnectionsTab",
  "fetchRulesUsingPost",
  "fetchRulesInCompactMode",
  "newLogsPanel",
  "grafanaconThemes",
  "alertingJiraIntegration",
  "alertingUseNewSimplifiedRoutingHashAlgorithm",
  "useScopesNavigationEndpoint",
  "scopeSearchAllLevels",
  "alertingRuleVersionHistoryRestore",
  "newShareReportDrawer",
  "rendererDisableAppPluginsPreload",
  "assetSriChecks",
  "alertRuleRestore",
  "infinityRunQueriesInParallel",
  "alertingMigrationUI",
  "alertingImportYAMLUI",
  "alertingMigrationWizardUI",
  "azureMonitorLogsBuilderEditor",
  "localeFormatPreference",
  "unifiedStorageGrpcConnectionPool",
  "alertingRulePermanentlyDelete",
  "alertingRuleRecoverDeleted",
  "multiTenantTempCredentials",
  "unifiedNavbars",
  "logsPanelControls",
  "metricsFromProfiles",
  ...
  "alertRuleUseFiredAtForStartsAt",
  "alertingBulkActionsInUI",
  "kubernetesAuthZResourcePermissionsRedirect",
  "kubernetesAuthzResourcePermissionApis",
  "kubernetesAuthzZanzanaSync",
  "kubernetesAuthzGlobalRolesApi",
  "kubernetesAuthzRolesApi",
  "kubernetesAuthzTeamLBACRuleApi",
  "kubernetesAuthzRoleBindingsApi",
  "kubernetesAuthzRolesAndRoleBindingsRedirect",
  "kubernetesAuthzDatasourceResourcePermissions",
  "restoreDashboards",
  "recentlyViewedDashboards",
  "experimentRecentlyViewedDashboards",
  "createdByMeSearchFilter",
  "alertEnrichment",
  "alertEnrichmentMultiStep",
  "alertEnrichmentConditional",
  "alertEnrichmentPreview",
  "alertingImportAlertmanagerAPI",
  "alertingDisableDMAinUI",
  "sharingDashboardImage",
  ...
  "otelLogsFormatting",
  "alertingNotificationHistory",
  "unifiedStorageSearchDualReaderEnabled",
  "dashboardLevelTimeMacros",
  "alertmanagerRemoteSecondaryWithRemoteState",
  ...
  "interactiveLearning",
  "alertingTriage",
  "alertingAlertsActivityBanner",
  "graphiteBackendMode",
  "azureResourcePickerUpdates",
  "prometheusTypeMigration",
  "pluginContainers",
  "cdnPluginsLoadFirst",
  "cdnPluginsUrls",
  "pluginInstallAPISync",
  "newVizSuggestions",
  "panelStyleActions",
  "vizPresets",
  "externalVizSuggestions",
  "nestedFramesFieldOverrides",
  "vizLegendFacetedFilter",
  "heatmapRowsAxisOptions",
  "pieChartGradientColorScheme",
  "preventPanelChromeOverflow",
  "jaegerEnableGrpcEndpoint",
  "pluginStoreServiceLoading",
  "newPanelPadding",
  "onlyStoreActionSets",
  "excludeRedundantManagedPermissions",
  "pluginInsights",
  "panelTimeSettings",
  "elasticsearchRawDSLQuery",
  "elasticsearchESQLQuery",
  "awsDatasourcesHttpProxy",
  "transformationsEmptyPlaceholder",
  "opentsdbBackendMigration",
  "ttlPluginInstanceManager",
  "lokiQueryLimitsContext",
  "rudderstackUpgrade",
  "kubernetesAlertingHistorian",
  "useMTPlugins",
  "multiPropsVariables",
  "dashboardSectionVariables",
  "smoothingTransformation",
  "secretsManagementAppPlatformAwsKeeper",
  "profilesExemplars",
  "alertingSyncDispatchTimer",
  "queryWithAssistant",
  "queryEditorNext",
  "kubernetesTeamBindings",
  "kubernetesTeamsApi",
  "kubernetesTeamsRedirect",
  "kubernetesUsersApi",
  "kubernetesServiceAccountsApi",
  "kubernetesServiceAccountTokensApi",
  "kubernetesSsoSettingsApi",
  "kubernetesExternalGroupMappingsApi",
  "kubernetesExternalGroupMappingsRedirect",
  "kubernetesTeamSync",
  "kubernetesUsersRedirect",
  "alertingMultiplePolicies",
  "alertingPolicyRoutingSettings",
  "appPluginAPIServer",
  "alertingIgnorePendingForNoDataAndError",
  "alertingNotificationHistoryRuleViewer",
  "alertingNotificationHistoryGlobal",
  "alertingNotificationHistoryTriage",
  "alertingNotificationHistoryDetail",
  "react19",
  "frontendServiceUseSettingsService",
  "functionalSharedPreferences",
  "managedPluginsV2",
  "rememberUserOrgForSso",
  "dsAbstractionApp",
  "datasourcesApiServerEnableHealthEndpoint",
  "analyticsFramework",
  "datasourcesApiServerEnableHealthEndpointFrontend",
  "flameGraphWithCallTree",
  "advisorDatasourceIntegration",
  "inlineLogDetailsNoScrolls",
  "colorblindThemes",
  "yAxisTickControl",
  "logsTablePanelNG",
  "useMTPluginSettings",
  "frontendServiceSSOAutoLogin",
  "splashScreen",
  "streamingForwardTeamHeadersTempo",
  "lokiAlignedQuerySplitting",
  "queryFetchConfigFromSettingsService",
  "queryServiceQueryCaching",
  "tracesDrilldownTimeSeeker",
  "clearPreviousFieldValues",
  "enableDatasourceMetaApiPluginLoading",
  "enableColorblindSafePanelOptions",
  "cacheConfigUnifiedStorageMigration",
  "compiledBootScript",
] as const;
