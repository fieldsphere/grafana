...
import { createStructuredLogger, type GrafanaTheme2, isIconName } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('packages/grafana-ui/src/components/Icon/Icon.tsx');
