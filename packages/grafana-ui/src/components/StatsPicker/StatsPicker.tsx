...
import { createStructuredLogger, fieldReducers, type FieldReducerInfo } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('packages/grafana-ui/src/components/StatsPicker/StatsPicker.tsx');
