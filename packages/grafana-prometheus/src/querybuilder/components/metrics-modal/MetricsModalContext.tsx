...
import { createStructuredLogger, type SelectableValue, type TimeRange } from '@grafana/data';
...
const structuredLogger = createStructuredLogger(
  'packages/grafana-prometheus/src/querybuilder/components/metrics-modal/MetricsModalContext.tsx'
);
