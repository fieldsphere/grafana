// k6-compatible logging function (k6 doesn't support CommonJS modules or Node globals)
function logDevenvWarning(message, context) {
  ...
  try {
    ...
    console.warn(JSON.stringify({ level: 'warning', message, context: String(context) }));
  }
}
