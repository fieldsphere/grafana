...
func (dc *CacheServiceImpl) GetDatasource(
	...
	dc.logger.FromContext(ctx).Debug("Querying for data source via SQL store", "datasourceID", datasourceID, "orgID", user.GetOrgID())
...
func (dc *CacheServiceImpl) GetDatasourceByUID(
	...
	dc.logger.FromContext(ctx).Debug("Querying for data source via SQL store", "datasourceUID", datasourceUID, "orgID", user.GetOrgID())
