...
var (
	...
	standardFeatureFlags = []FeatureFlag{
		...
		{
			Name:         "experimentStatSigFlags",
			Description:  "Umbrella flag for statistical significance experiment feature flags",
			Stage:        FeatureStageExperimental,
			Owner:        grafanaFrontendNavigation,
			FrontendOnly: true,
			HideFromDocs: true,
		...
		{
			Name:         "experimentStatSigNewFlags",
			Description:  "Enables new statistical significance experiment feature flags we are trialing",
			Stage:        FeatureStageExperimental,
			Owner:        grafanaFrontendNavigation,
			FrontendOnly: true,
			HideFromDocs: true,
