...
func NewUploader(keyFile, bucket, path string, enableSignedURLs bool, signedURLExpiration time.Duration) (*Uploader, error) {
	...
	uploader.log.Debug("Created uploader", "keyFile", keyFile, "bucket", bucket, "objectPathPrefix", path, "enableSignedUrls",
...
func (u *Uploader) uploadFile(
	...
	u.log.Debug("Opening image file", "imageFilePath", imageDiskPath)
	...
	defer func() {
		if err := fileReader.Close(); err != nil {
			u.log.Warn("Failed to close file", "error", err, "imageFilePath", imageDiskPath)
		}
	}()
