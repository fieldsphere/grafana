...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Get("/admin/feature-toggles", authorize(ac.EvalPermission(ac.ActionSettingsRead, ac.ScopeSettingsAll)), hs.Index)
	...
	r.Group("/api/admin", func(adminRoute routing.RouteRegister) {
		...
		adminRoute.Get("/feature-toggles", authorize(ac.EvalPermission(ac.ActionSettingsRead)), routing.Wrap(hs.GetFeatureToggles))
