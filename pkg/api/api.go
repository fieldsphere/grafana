...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Get("/labs", authorize(ac.EvalPermission(ac.ActionDatasourcesExplore)), hs.Index)
	...
	r.Group("/api", func(apiRoute routing.RouteRegister) {
		...
		apiRoute.Get("/labs/feature-toggles", authorize(ac.EvalPermission(ac.ActionDatasourcesExplore)), hs.GetLabsFeatureToggles)
