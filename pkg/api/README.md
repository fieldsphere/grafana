...
## OpenAPI v3 enhancements

The conversion script applies several enhancements when generating the OpenAPI v3 specification:

- **Server configuration**: Adds a proper server URL with description
- **License information**: Includes AGPL v3.0 license details
- **External documentation**: Links to the official Grafana HTTP API documentation
- **Response descriptions**: Automatically generates meaningful descriptions for responses
- **Security scheme descriptions**: Adds descriptions to authentication methods (API key, Basic auth)
