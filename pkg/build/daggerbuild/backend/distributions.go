...
func DistroOptsLogger(log *slog.Logger, fn DistroBuildOptsFunc) func(distro Distribution, experiments []string, tags []string) *GoBuildOpts {
	return func(distro Distribution, experiments []string, tags []string) *GoBuildOpts {
		...
		log.Debug("Building with options", "distribution", distro, "experiments", experiments, "tags", tags, "operatingSystem", opts.OS, "arch", opts.Arch, "arm", opts.GoARM, "cgoEnabled", opts.CGOEnabled, "go386", opts.Go386, "cc", opts.CC, "cxx", opts.CXX)
		return opts
	}
}
