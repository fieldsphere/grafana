...
export function logScriptInfo(message: string, context?: LogContext) {
  process.stdout.write(formatLogLine('info', message, context));
}

export function logScriptWarning(message: string, context?: LogContext) {
  process.stderr.write(formatLogLine('warning', message, context));
}

export function logScriptError(message: string, context?: LogContext) {
