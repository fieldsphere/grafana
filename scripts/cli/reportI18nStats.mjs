...
function logStat(name, value) {
  ...
  Reflect.apply(Reflect.get(globalThis, '__structuredLog') ?? Reflect.get(console, 'info'), console, [{ timestamp: new Date().toISOString(), level: 'info', source: 'scripts/cli/reportI18nStats.mjs', args: [`${name} ${value}`] }]);
}
