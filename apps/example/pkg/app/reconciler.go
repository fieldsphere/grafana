...
func (e *ExampleReconciler) doReconcile(ctx context.Context, req operator.TypedReconcileRequest[*v1alpha1.Example]) (operator.ReconcileResult, error) {
	...
	logging.FromContext(ctx).Info("reconciling example", "exampleName", req.Object.GetName(), "namespace", req.Object.GetNamespace(), "resourceAction", operator.ResourceActionFromReconcileAction(req.Action))
