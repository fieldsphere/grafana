...
import { createStructuredLogger, type DataFrame, type DataFrameView, type IconName, fuzzySearch } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/features/search/service/utils.ts');
