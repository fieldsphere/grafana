...
import { createStructuredLogger, ActionType, type DataSourceInstanceSettings } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/features/actions/ConnectionPicker.tsx');
