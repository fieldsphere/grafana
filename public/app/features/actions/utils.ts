...
import { BackendSrvRequest, config as grafanaConfig, createStructuredLogger, getBackendSrv } from '@grafana/runtime';

const logger = createStructuredLogger('ActionsUtils');
            ...
            getBackendSrv()
              ...
              .subscribe({
                error: (error) => {
                  ...
                  logger.error('Action fetch request failed', error);
                },
                complete: () => {
