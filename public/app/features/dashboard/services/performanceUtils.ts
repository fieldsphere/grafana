...
export function writePerformanceGroupStart(logger: string, message: string): void {
  if (isPerformanceLoggingEnabled()) {
    // eslint-disable-next-line no-console -- console.groupCollapsed not mapped to structured logger
...
export function writePerformanceGroupEnd(): void {
  if (isPerformanceLoggingEnabled()) {
    // eslint-disable-next-line no-console -- console.groupEnd not mapped to structured logger
    console.groupEnd();
  }
}
