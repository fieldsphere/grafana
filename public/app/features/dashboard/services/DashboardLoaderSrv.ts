...
import { createStructuredLogger, AppEvents, dateMath, type UrlQueryMap, type UrlQueryValue } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/features/dashboard/services/DashboardLoaderSrv.ts');
