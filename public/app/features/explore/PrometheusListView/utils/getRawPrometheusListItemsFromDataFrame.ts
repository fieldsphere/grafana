import { createStructuredLogger, type DataFrame, formattedValueToString } from '@grafana/data';

import { type instantQueryRawVirtualizedListData } from '../RawListContainer';

const structuredLogger = createStructuredLogger(
  'public/app/features/explore/PrometheusListView/utils/getRawPrometheusListItemsFromDataFrame.ts'
);
