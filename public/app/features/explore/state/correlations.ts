...
import { CorrelationData, createStructuredLogger, getDataSourceSrv, reportInteraction } from '@grafana/runtime';

const logger = createStructuredLogger('ExploreCorrelations');
