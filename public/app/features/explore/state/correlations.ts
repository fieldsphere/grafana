...
import { createStructuredLogger, type DataLinkTransformationConfig } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/features/explore/state/correlations.ts');
