...
const logger = createStructuredLogger('OpenQueryLibraryExposedComponent');
...
export const OpenQueryLibraryExposedComponent = ({
  ...
  if (!queryLibraryEnabled) {
    logger.warn('Attempted to use unsupported exposed component. Query library is not enabled.');
    return null;
  }
