...
const logger = createMonitoringLogger('features.explore.trace-create-span-link');
    ...
    if (hasLinks) {
      ...
      try {
        ...
        if (error instanceof Error) {
          logger.logError(error, { operation: 'createSpanLinks' });
        } else {
          logger.logWarning('Failed to create span links', { operation: 'createSpanLinks', error: String(error) });
        }
        return spanLinks;
      }
    }
