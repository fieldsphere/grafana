...
export const sharedDependenciesMap = {
  ...
  // "react-router-dom" now bundles a native react-router-dom v6, and "react-router" is what it depends on
  // internally, so exposing both keeps plugins bundling either package working with a single shared instance.
