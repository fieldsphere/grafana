...
import { createStructuredLogger, type SelectableValue, type GrafanaTheme2, type PluginType } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/features/plugins/admin/pages/Browse.tsx');
