...
import { config, getBackendSrv, isFetchError, logError, logInfo } from '@grafana/runtime';
    ...
    forkJoin({
      ...
      .subscribe(
        ...
        (error) => {
          ...
          logInfo(`Error fetching plugins: ${errorObj.message}`, {
