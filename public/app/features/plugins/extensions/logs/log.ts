...
import { createStructuredLogger, type Labels, LogLevel } from '@grafana/data';
import { config, createMonitoringLogger } from '@grafana/runtime';

const structuredLogger = createStructuredLogger('public/app/features/plugins/extensions/logs/log.ts');
