...
import { config, locationSearchToObject, createMonitoringLogger } from '@grafana/runtime';
...
const logger = createMonitoringLogger('grafana.features.plugins.components.AppRootPage');
