...
import { config, getBackendSrv, locationService, logError } from '@grafana/runtime';
  ...
  useEffect(() => {
    async function fetchOptions() {
      try {
        ...
        logError(e instanceof Error ? e : new Error('Error loading options'), {
          context: 'Service account create page',
          orgId: currentOrgId,
        });
      }
    }
  ...
  const onSubmit = useCallback(
    async (data: ServiceAccountDTO) => {
      ...
      try {
        ...
        logError(e instanceof Error ? e : new Error('Failed to create service account'), {
          context: 'Service account creation',
        });
      }
