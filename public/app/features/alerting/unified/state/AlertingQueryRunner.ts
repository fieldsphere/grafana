...
const logger = createMonitoringLogger('features.alerting.query-runner');
...
const getTimeRange = (query: AlertQuery, queries: AlertQuery[]): TimeRange => {
  ...
  if (!query.relativeTimeRange) {
    logger.logWarning('Query did not have any relative time range, using default.', { refId: query.refId });
