...
import { createStructuredLogger, type GrafanaTheme2, OrgRole } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/features/admin/UserOrgs.tsx');
