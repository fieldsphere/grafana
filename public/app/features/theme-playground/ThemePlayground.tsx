...
import { createStructuredLogger, createTheme, type GrafanaTheme2, type NewThemeOptions } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/features/theme-playground/ThemePlayground.tsx');
