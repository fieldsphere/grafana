import { createStructuredLogger, type AdHocVariableFilter, type TypedVariableModel } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/features/dashboard-scene/utils/variables.ts');
