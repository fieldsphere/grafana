...
import { createStructuredLogger, type NavModel, type NavModelItem, PageLayoutType } from '@grafana/data';
import {
...
const structuredLogger = createStructuredLogger('public/app/features/dashboard-scene/settings/VariablesEditView.tsx');
