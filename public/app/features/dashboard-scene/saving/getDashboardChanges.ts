...
const logger = createMonitoringLogger('features.dashboard-scene.get-dashboard-changes');
...
export function adHocVariableFiltersEqual(filtersA?: AdHocFilterWithLabels[], filtersB?: AdHocFilterWithLabels[]) {
  if (filtersA === undefined && filtersB === undefined) {
    logger.logWarning('Adhoc variable filter property is undefined', { filtersA: 'undefined', filtersB: 'undefined' });
    return true;
  }
  ...
  if ((filtersA === undefined && filtersB !== undefined) || (filtersB === undefined && filtersA !== undefined)) {
    logger.logWarning('Adhoc variable filter property is undefined', {
      filtersA: filtersA === undefined ? 'undefined' : 'defined',
      filtersB: filtersB === undefined ? 'undefined' : 'defined',
    });
    return false;
  }
