...
import { locationService, createMonitoringLogger } from '@grafana/runtime';
import { UrlSyncContextProvider } from '@grafana/scenes';
import { Box } from '@grafana/ui';

const logger = createMonitoringLogger('grafana.features.dashboard-scene.pages.DashboardScenePage');
...
export function DashboardScenePage({ route, queryParams, location }: Props) {
  ...
  if (type !== 'snapshot' && (!prevMatch || uid !== prevMatch?.params.uid)) {
    logger.logDebug('skipping rendering');
    return null;
  }
