import { createStructuredLogger, type UrlQueryMap, getTimeZone, getDefaultTimeRange, dateMath } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/features/dashboard-scene/pages/utils.ts');
