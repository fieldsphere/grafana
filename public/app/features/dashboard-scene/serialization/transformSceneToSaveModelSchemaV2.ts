...
const logger = createMonitoringLogger('grafana.features.dashboard-scene.serialization.transformSceneToSaveModelSchemaV2');
...
export function transformSceneToSaveModelSchemaV2(scene: DashboardScene, isSnapshot = false): DashboardV2Spec {
  ...
  try {
    ...
    logger.logError('Error transforming dashboard to schema v2: ' + reason, dashboardSchemaV2);
