...
const logger = createStructuredLogger('TransformSceneToSaveModelSchemaV2');
import {
  behaviors,
  dataLayers,
  QueryVariable,
...
export function transformSceneToSaveModelSchemaV2(scene: DashboardScene, isSnapshot = false): DashboardV2Spec {
  ...
  try {
    ...
    logger.error('Error transforming dashboard to schema v2', reason as Error, { dashboardSchemaV2 });
