  ...
  public draggedGridItemOutside?(gridItem: SceneGridItemLike): void {
    ...
    if (gridItem instanceof DashboardGridItem || gridItem instanceof AutoGridItem) {
      ...
      if (gridItem instanceof DashboardGridItem && layout instanceof SceneGridLayout) {
        ...
        Reflect.apply(Reflect.get(globalThis, '__structuredLog') ?? Reflect.get(console, 'warn'), console, [{ timestamp: new Date().toISOString(), level: 'warn', source: 'public/app/features/dashboard-scene/scene/layout-rows/RowItem.tsx', args: [warningMessage] }]);
