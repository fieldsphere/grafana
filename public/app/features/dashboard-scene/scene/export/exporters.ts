...
import { createStructuredLogger, type DataSourceRef, type VariableOption, VariableRefresh } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/features/dashboard-scene/scene/export/exporters.ts');
