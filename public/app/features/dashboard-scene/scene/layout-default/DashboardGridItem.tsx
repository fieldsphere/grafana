...
const logger = createMonitoringLogger('features.dashboard-scene.dashboard-grid-item');
  ...
  implements SceneGridItemLike, DashboardLayoutItem
{
  ...
  public performRepeat() {
    ...
    if (!(variable instanceof MultiValueVariable)) {
      logger.logWarning('DashboardGridItem: variable is not a MultiValueVariable', {
