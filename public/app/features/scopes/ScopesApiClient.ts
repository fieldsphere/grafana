import { createStructuredLogger, type Scope, type ScopeDashboardBinding, type ScopeNode } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/features/scopes/ScopesApiClient.ts');
