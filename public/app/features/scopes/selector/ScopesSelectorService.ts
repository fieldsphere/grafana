import { createStructuredLogger, type Scope, type ScopeNode, store as storeImpl } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/features/scopes/selector/ScopesSelectorService.ts');
