...
import { createStructuredLogger, AppEvents, type PanelData, type SelectableValue, LoadingState } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/features/inspector/InspectJSONTab.tsx');
