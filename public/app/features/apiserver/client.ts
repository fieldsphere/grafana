...
const apiServerLogger = createMonitoringLogger('apiserver.watch');
      ...
      .pipe(
        ...
        map((line) => {
          try {
            ...
            apiServerLogger.logWarning('Invalid JSON in watch stream', {
              group: this.gvr.group,
              version: this.gvr.version,
              resource: this.gvr.resource,
              url: this.url,
