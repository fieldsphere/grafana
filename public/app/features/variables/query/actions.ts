...
import { createStructuredLogger, type DataSourceRef } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/features/variables/query/actions.ts');
