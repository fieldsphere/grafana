...
import { createStructuredLogger, type SwitchVariableModel } from '@grafana/data';
import { Switch } from '@grafana/ui';

import { variableAdapters } from '../adapters';
import { type VariablePickerProps } from '../pickers/types';

const structuredLogger = createStructuredLogger('public/app/features/variables/switch/SwitchVariablePicker.tsx');
