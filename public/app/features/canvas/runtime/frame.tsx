    ...
    switch (action) {
      ...
      case LayerActionID.Duplicate:
        if (element.item.id === 'frame') {
          (Reflect.get(globalThis, '__grafanaStructuredConsole') ?? console).log('Can not duplicate frames (yet)', action, element);
          return;
        }
      ...
      default:
        (Reflect.get(globalThis, '__grafanaStructuredConsole') ?? console).log('DO action', action, element);
        return;
    }
  };
