...
import { createStructuredLogger, DataHoverEvent, type PanelData, type PanelProps } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/plugins/panel/geomap/GeomapPanel.tsx');
