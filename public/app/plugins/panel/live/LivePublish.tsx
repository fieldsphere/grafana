...
import { getBackendSrv, getGrafanaLiveSrv, logStructuredDebug } from '@grafana/runtime';
...
export function LivePublish({ height, mode, body, addr, onSave }: Props) {
  ...
  const onPublishClicked = async () => {
    ...
    logStructuredDebug('plugins.panel.live', 'onPublishClicked (response from publish)', rsp);
  };
