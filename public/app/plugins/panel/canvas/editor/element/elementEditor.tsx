...
const logger = createMonitoringLogger('plugins.panel.canvas.element-editor');
    ...
    values: (parent: NestedValueAccess) => ({
      ...
      onChange: (path, value) => {
        ...
        if (path === 'type' && value) {
          ...
          if (!layer) {
            logger.logWarning('Layer does not exist', {
              operation: 'getElementEditor.values.onChange',
