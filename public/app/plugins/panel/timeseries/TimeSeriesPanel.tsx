...
import { applySeriesOverlays } from './overlays';
...
export const TimeSeriesPanel = ({
  ...
  const { frames, compareDiffMs } = useMemo(() => {
    ...
    if (frames != null) {
      ...
      // Overlays run after compare-series alignment so OLS uses the visible time domain.
      frames = applySeriesOverlays(frames, options.overlay, timeRange, theme);
