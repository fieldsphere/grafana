...
import { createStructuredLogger, DashboardCursorSync, type PanelProps, type TimeRange } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/plugins/panel/heatmap/HeatmapPanel.tsx');
