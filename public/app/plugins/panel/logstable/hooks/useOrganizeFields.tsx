...
import { createStructuredLogger, type DataFrame, type FieldConfigSource, transformDataFrame } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/plugins/panel/logstable/hooks/useOrganizeFields.tsx');
