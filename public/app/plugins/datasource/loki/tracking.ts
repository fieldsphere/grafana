import {
  CoreApp, type DashboardLoadedEvent, type DataQueryRequest, type DataQueryResponse,
  structuredLog,
  toLogContextPart
} from '@grafana/data';
...
export const onDashboardLoadedHandler = ({
  ...
  try {
    ...
    structuredLog('error', 'error in loki tracking handler', { error: toLogContextPart(error) });
  }
};
