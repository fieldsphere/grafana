...
try {
  ...
  structuredLog.info(labelKeys);
} catch (error) {
  structuredLog.error(`Error fetching label keys: ${error.message}`);
}
```
...
try {
  ...
  structuredLog.info(values);
} catch (error) {
  structuredLog.error(`Error fetching label values: ${error.message}`);
}
...
try {
  ...
  structuredLog.info(labels);
} catch (error) {
  structuredLog.error(`Error fetching labels: ${error.message}`);
}
```
...
try {
  ...
  structuredLog.info(parserAndLabelKeys);
} catch (error) {
  structuredLog.error(`Error fetching parser and label keys: ${error.message}`);
}
```
