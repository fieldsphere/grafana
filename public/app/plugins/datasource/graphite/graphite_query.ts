...
import { createStructuredLogger, type ScopedVars } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/plugins/datasource/graphite/graphite_query.ts');
