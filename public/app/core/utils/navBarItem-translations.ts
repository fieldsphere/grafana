...
export function getNavSubTitle(navId: string | undefined) {
  switch (navId) {
    ...
    case 'labs':
      return t('nav.labs.subtitle', 'Try and manage experimental Grafana capabilities');
    case 'labs/feature-flags':
      return t('nav.labs-feature-flags.subtitle', 'View and control feature flag overrides');
