...
export function getNavSubTitle(navId: string | undefined) {
  switch (navId) {
    ...
    case 'labs':
      return t('nav.labs.subtitle', 'Explore and control experimental Grafana capabilities');
    case 'labs-feature-flags':
      return t('nav.labs-feature-flags.subtitle', 'View and control enabled feature flags');
    case 'connections-datasources':
