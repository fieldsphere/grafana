...
export function getNavSubTitle(navId: string | undefined) {
  switch (navId) {
    ...
    case 'labs':
      return t('nav.labs.subtitle', 'Experiment with runtime feature flags in your current browser session');
    case 'labs-feature-toggles':
      return t('nav.labs-feature-toggles.subtitle', 'View enabled flags and override them for this browser session');
