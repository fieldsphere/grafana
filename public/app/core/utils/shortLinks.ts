...
import { createStructuredLogger, type AbsoluteTimeRange, type LogRowModel, type UrlQueryMap } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/core/utils/shortLinks.ts');
