...
import { logStructuredDebug, type BackendSrvRequest } from '@grafana/runtime';
...
export class FetchQueue {
  ...
  private printState = (update: FetchQueueUpdate, debug: boolean): void => {
    ...
    logStructuredDebug('core.services', 'FetchQueue noOfStarted', update.noOfInProgress);
    logStructuredDebug('core.services', 'FetchQueue noOfNotStarted', update.noOfPending);
    logStructuredDebug('core.services', 'FetchQueue state', entriesWithoutOptions);
  };
}
