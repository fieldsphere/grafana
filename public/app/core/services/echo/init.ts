import { config, registerEchoBackend, setEchoSrv, logError } from '@grafana/runtime';
...
export async function initEchoSrv() {
  ...
  try {
    ...
    logError(error instanceof Error ? error : new Error(String(error)), {
      message: 'Error initializing EchoSrv Performance backend',
    });
  }
  ...
  try {
    ...
    logError(error instanceof Error ? error : new Error(String(error)), {
      message: 'Error initializing EchoSrv Faro backend',
    });
  }
  ...
  try {
    ...
    logError(error instanceof Error ? error : new Error(String(error)), {
      message: 'Error initializing EchoSrv GoogleAnalytics backend',
    });
  }
  ...
  try {
    ...
    logError(error instanceof Error ? error : new Error(String(error)), {
      message: 'Error initializing EchoSrv GoogleAnalaytics4 backend',
    });
  }
  ...
  try {
    ...
    logError(error instanceof Error ? error : new Error(String(error)), {
      message: 'Error initializing EchoSrv Rudderstack backend',
    });
  }
  ...
  try {
    ...
    logError(error instanceof Error ? error : new Error(String(error)), {
      message: 'Error initializing EchoSrv AzureAppInsights backend',
    });
  }
  ...
  try {
    ...
    logError(error instanceof Error ? error : new Error(String(error)), {
      message: 'Error initializing EchoSrv Console backend',
    });
  }
}
