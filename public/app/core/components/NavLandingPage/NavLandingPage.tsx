...
import { createStructuredLogger, type GrafanaTheme2, type NavModelItem } from '@grafana/data';
...
const structuredLogger = createStructuredLogger('public/app/core/components/NavLandingPage/NavLandingPage.tsx');
