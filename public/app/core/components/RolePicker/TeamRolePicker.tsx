...
const logger = createMonitoringLogger('core.components.team-role-picker');
    ...
    if (!apply) {
      try {
        ...
        if (error instanceof Error) {
          logger.logError(error, { operation: 'onRolesChange', teamId, orgId });
          return;
        }
        logger.logWarning('Error updating team roles', {
